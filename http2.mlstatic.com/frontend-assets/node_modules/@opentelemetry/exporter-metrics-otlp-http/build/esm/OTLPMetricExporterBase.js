...
export var CumulativeTemporalitySelector = function () {
...
function chooseTemporalitySelectorFromEnvironment() {
  ...
  diag.warn(
    "OTEL_EXPORTER_OTLP_METRICS_TEMPORALITY_PREFERENCE is set to '" +
      env.OTEL_EXPORTER_OTLP_METRICS_TEMPORALITY_PREFERENCE +
      "', but only 'cumulative' and 'delta' are allowed. Using default ('cumulative') instead."
  );
  return CumulativeTemporalitySelector;
}
...
function chooseAggregationSelector(config) {
  if (
    config === null || config === void 0 ? void 0 : config.aggregationPreference
  ) {
...
var OTLPMetricExporterBase = /** @class */ (function (_super) {
  ...
  function OTLPMetricExporterBase(delegate, config) {
    ...
    _this._aggregationTemporalitySelector = chooseTemporalitySelector(
  ...
  OTLPMetricExporterBase.prototype.selectAggregation = function (
    instrumentType
  ) {
    return this._aggregationSelector(instrumentType);
  };
  OTLPMetricExporterBase.prototype.selectAggregationTemporality = function (
    instrumentType
  ) {
