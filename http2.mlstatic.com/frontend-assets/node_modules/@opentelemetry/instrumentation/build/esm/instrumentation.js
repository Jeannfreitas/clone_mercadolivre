...
var InstrumentationAbstract = /** @class */ (function () {
  function InstrumentationAbstract(
    instrumentationName,
   ...
   * @param meterProvider
   */
  InstrumentationAbstract.prototype.setMeterProvider = function (
    meterProvider
  ) {
   ...
   */
  InstrumentationAbstract.prototype.setLoggerProvider = function (
    loggerProvider
  ) {
   ...
   */
  InstrumentationAbstract.prototype.setTracerProvider = function (
    tracerProvider
  ) {
   ...
   */
  InstrumentationAbstract.prototype._runSpanCustomizationHook = function (
    hookHandler,
    triggerName,
    span,
    info
