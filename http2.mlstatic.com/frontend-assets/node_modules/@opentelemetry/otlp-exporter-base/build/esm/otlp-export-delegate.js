...
var OTLPExportDelegate = /** @class */ (function () {
  ...
  OTLPExportDelegate.prototype.export = function (
    ...
    var serializedRequest = this._serializer.serializeRequest(
      internalRepresentation
    );
        ...
        function (response) {
          if (response.status === "success") {
            if (response.data != null) {
              try {
                _this._responseHandler.handleResponse(
                  _this._serializer.deserializeResponse(response.data)
                );
              } catch (e) {
                _this._diagLogger.warn(
