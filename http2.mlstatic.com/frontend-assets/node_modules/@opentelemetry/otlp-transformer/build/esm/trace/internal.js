...
export function sdkSpanToOtlpSpan(span, encoder) {
  ...
  return {
    ...
    traceState:
      (_a = ctx.traceState) === null || _a === void 0 ? void 0 : _a.serialize(),
    name: span.name,
...
export function toOtlpLink(link, encoder) {
  ...
  return {
    ...
    traceState:
      (_a = link.context.traceState) === null || _a === void 0
        ? void 0
        : _a.serialize(),
...
function createResourceMap(readableSpans) {
  ...
  try {
    for (
      var readableSpans_1 = __values(readableSpans),
        readableSpans_1_1 = readableSpans_1.next();
      !readableSpans_1_1.done;
      readableSpans_1_1 = readableSpans_1.next()
    ) {
