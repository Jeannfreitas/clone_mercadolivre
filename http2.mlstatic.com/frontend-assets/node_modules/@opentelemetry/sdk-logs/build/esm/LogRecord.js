...
var LogRecord = /** @class */ (function () {
  function LogRecord(_sharedState, instrumentationScope, logRecord) {
    ...
    var now = Date.now();
    this.hrTime = timeInputToHrTime(
      timestamp !== null && timestamp !== void 0 ? timestamp : now
    );
    this.hrTimeObserved = timeInputToHrTime(
      observedTimestamp !== null && observedTimestamp !== void 0
        ? observedTimestamp
        : now
    );
    if (context) {
