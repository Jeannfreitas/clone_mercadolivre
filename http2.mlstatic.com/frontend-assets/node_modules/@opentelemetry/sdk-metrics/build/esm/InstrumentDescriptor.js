...
export function createInstrumentDescriptor(name, type, options) {
  ...
  if (!isValidName(name)) {
    diag.warn(
      'Invalid metric name: "' +
        name +
        '". The metric name should be a ASCII string with a length no greater than 255 characters.'
    );
  }
  return {
    name: name,
    ...
    description:
      (_a =
        options === null || options === void 0
          ? void 0
          : options.description) !== null && _a !== void 0
        ? _a
        : "",
    unit:
      (_b = options === null || options === void 0 ? void 0 : options.unit) !==
        null && _b !== void 0
        ? _b
        : "",
    valueType:
...
export function createInstrumentDescriptorWithView(view, instrument) {
  ...
  return {
    ...
    description:
      (_b = view.description) !== null && _b !== void 0
        ? _b
