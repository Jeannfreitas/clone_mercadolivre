...
var ExponentialHistogramAccumulation = /** @class */ (function () {
  function ExponentialHistogramAccumulation(
    ...
    if (this._maxSize < MIN_MAX_SIZE) {
      diag.warn(
        "Exponential Histogram Max Size set to " +
          this._maxSize +
   ...
   */
  ExponentialHistogramAccumulation.prototype.setStartTime = function (
    startTime
  ) {
    this.startTime = startTime;
  };
  ...
  Object.defineProperty(
    ExponentialHistogramAccumulation.prototype,
    "zeroCount",
    {
      /**
   ...
   * @param increment
   */
  ExponentialHistogramAccumulation.prototype.updateByIncrement = function (
    value,
    increment
  ) {
   ...
   */
  ExponentialHistogramAccumulation.prototype._updateBuckets = function (
    buckets,
    value,
    increment
  ) {
   ...
   * be added if needed.
   */
  ExponentialHistogramAccumulation.prototype._incrementIndexBy = function (
    buckets,
    index,
    increment
  ) {
   ...
   */
  ExponentialHistogramAccumulation.prototype._grow = function (
    buckets,
    needed
  ) {
   ...
   */
  ExponentialHistogramAccumulation.prototype._changeScale = function (
    high,
    low
  ) {
    var change = 0;
  ...
  ExponentialHistogramAccumulation.prototype._minScale = function (other) {
    ...
    var highLowNeg = HighLow.combine(
   ...
   */
  ExponentialHistogramAccumulation.prototype._highLowAtScale = function (
    buckets,
    currentScale,
    newScale
  ) {
   ...
   */
  ExponentialHistogramAccumulation.prototype._mergeBuckets = function (
    ours,
    other,
    theirs,
    scale
   ...
   */
  ExponentialHistogramAccumulation.prototype._diffBuckets = function (
    ours,
    other,
    theirs,
    scale
...
var ExponentialHistogramAggregator = /** @class */ (function () {
  ...
  ExponentialHistogramAggregator.prototype.createAccumulation = function (
    startTime
  ) {
    return new ExponentialHistogramAccumulation(
      startTime,
  ...
  ExponentialHistogramAggregator.prototype.toMetricData = function (
    descriptor,
