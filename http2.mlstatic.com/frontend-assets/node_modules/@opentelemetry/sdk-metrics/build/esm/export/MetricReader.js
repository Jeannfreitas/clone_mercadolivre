...
var MetricReader = /** @class */ (function () {
  function MetricReader(options) {
    ...
    this._aggregationSelector =
      (_a =
        options === null || options === void 0
          ? void 0
          : options.aggregationSelector) !== null && _a !== void 0
        ? _a
        : DEFAULT_AGGREGATION_SELECTOR;
    this._aggregationTemporalitySelector =
      (_b =
        options === null || options === void 0
          ? void 0
          : options.aggregationTemporalitySelector) !== null && _b !== void 0
        ? _b
        : DEFAULT_AGGREGATION_TEMPORALITY_SELECTOR;
    this._metricProducers =
      (_c =
        options === null || options === void 0
          ? void 0
          : options.metricProducers) !== null && _c !== void 0
        ? _c
        : [];
    this._cardinalitySelector =
      options === null || options === void 0
        ? void 0
        : options.cardinalitySelector;
  }
  /**
   ...
   */
  MetricReader.prototype.selectAggregationTemporality = function (
    instrumentType
  ) {
        ...
        switch (_b.label) {
            ...
            return [
              ...
              Promise.all(
                __spreadArray(
                  ...
                  __read(
                    this._metricProducers.map(function (producer) {
          ...
          case 1:
            (_a = __read.apply(void 0, [_b.sent()])),
              (sdkCollectionResults = _a[0]),
              (additionalCollectionResults = _a.slice(1));
            errors = sdkCollectionResults.errors.concat(
              FlatMap(additionalCollectionResults, function (result) {
