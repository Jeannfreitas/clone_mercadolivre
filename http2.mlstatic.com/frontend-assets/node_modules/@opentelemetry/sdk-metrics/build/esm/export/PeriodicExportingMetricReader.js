...
var PeriodicExportingMetricReader = /** @class */ (function (_super) {
  ...
  function PeriodicExportingMetricReader(options) {
    ...
    var _this =
      _super.call(this, {
        aggregationSelector:
          (_a = options.exporter.selectAggregation) === null || _a === void 0
            ? void 0
            : _a.bind(options.exporter),
        aggregationTemporalitySelector:
          (_b = options.exporter.selectAggregationTemporality) === null ||
          _b === void 0
            ? void 0
            : _b.bind(options.exporter),
    ...
    _this._exportInterval =
      (_c = options.exportIntervalMillis) !== null && _c !== void 0
        ? _c
        : 60000;
    _this._exportTimeout =
      (_d = options.exportTimeoutMillis) !== null && _d !== void 0 ? _d : 30000;
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              callWithTimeout(this._doRun(), this._exportTimeout),
            ];
          case 1:
            _a.sent();
            return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_e) {
        switch (_e.label) {
          ...
          case 1:
            (_c = _e.sent()),
              (resourceMetrics = _c.resourceMetrics),
              (errors = _c.errors);
            if (errors.length > 0) {
              (_d = api.diag).error.apply(
                _d,
                __spreadArray(
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              (_b = (_a = resourceMetrics.resource).waitForAsyncAttributes) ===
                null || _b === void 0
                ? void 0
                : _b.call(_a),
            ];
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              internal._export(this._exporter, resourceMetrics),
            ];
          case 6:
            result = _e.sent();
            if (result.code !== ExportResultCode.SUCCESS) {
              throw new Error(
                "PeriodicExportingMetricReader: metrics export failed (error " +
                  result.error +
                  ")"
              );
            }
