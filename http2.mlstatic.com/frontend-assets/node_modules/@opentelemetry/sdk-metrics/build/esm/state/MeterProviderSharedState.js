...
var MeterProviderSharedState = /** @class */ (function () {
  ...
  MeterProviderSharedState.prototype.getMeterSharedState = function (
  ...
  MeterProviderSharedState.prototype.selectAggregations = function (
    instrumentType
  ) {
    var e_1, _a;
    var result = [];
    try {
      for (
        var _b = __values(this.metricCollectors), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
