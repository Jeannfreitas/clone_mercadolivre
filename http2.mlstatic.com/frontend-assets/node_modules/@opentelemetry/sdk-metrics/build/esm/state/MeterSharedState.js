...
var MeterSharedState = /** @class */ (function () {
  ...
  MeterSharedState.prototype.registerAsyncMetricStorage = function (
    descriptor
  ) {
   ...
   */
  MeterSharedState.prototype.collect = function (
    collector,
    collectionTime,
    options
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.observableRegistry.observe(
                collectionTime,
  ...
  MeterSharedState.prototype._registerMetricStorage = function (
    descriptor,
    MetricStorageType
  ) {
    var _this = this;
    var views = this._meterProviderSharedState.viewRegistry.findViews(
      descriptor,
    ...
    var storages = views.map(function (view) {
      ...
      var compatibleStorage =
        _this.metricStorageRegistry.findOrUpdateCompatibleStorage(
          viewDescriptor
        );
      ...
      var viewStorage = new MetricStorageType(
        viewDescriptor,
        aggregator,
        view.attributesProcessor,
        _this._meterProviderSharedState.metricCollectors,
    ...
    if (storages.length === 0) {
      ...
      var collectorStorages = perCollectorAggregations.map(function (_a) {
        var _b = __read(_a, 2),
          ...
          aggregation = _b[1];
        var compatibleStorage =
          _this.metricStorageRegistry.findOrUpdateCompatibleCollectorStorage(
            collector,
            descriptor
          );
        if (compatibleStorage != null) {
        ...
        var cardinalityLimit = collector.selectCardinalityLimit(
          descriptor.type
        );
        var storage = new MetricStorageType(
          descriptor,
          aggregator,
