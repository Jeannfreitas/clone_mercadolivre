...
var MetricCollector = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            scopeMetrics = [];
            errors = [];
            meterCollectionPromises = Array.from(
              this._sharedState.meterSharedStates.values()
            ).map(function (meterSharedState) {
                  ...
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      if (
                        ...
                        errors.push.apply(
                          errors,
                          __spreadArray([], __read(current.errors), false)
                        );
                      }
                      return [2 /*return*/];
                  }
  ...
  MetricCollector.prototype.selectAggregationTemporality = function (
    instrumentType
  ) {
  ...
  MetricCollector.prototype.selectCardinalityLimit = function (instrumentType) {
    var _a, _b, _c;
    return (_c =
      (_b = (_a = this._metricReader).selectCardinalityLimit) === null ||
      _b === void 0
        ? void 0
        : _b.call(_a, instrumentType)) !== null && _c !== void 0
      ? _c
      : 2000;
  };
