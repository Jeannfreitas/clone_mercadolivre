...
var TemporalMetricProcessor = /** @class */ (function () {
   ...
   */
  TemporalMetricProcessor.prototype.buildMetrics = function (
    collector,
  ...
  TemporalMetricProcessor.prototype._stashAccumulations = function (
    currentAccumulation
  ) {
    var e_1, _a;
    ...
    try {
      for (
        var registeredCollectors_1 = __values(registeredCollectors),
          registeredCollectors_1_1 = registeredCollectors_1.next();
        !registeredCollectors_1_1.done;
        registeredCollectors_1_1 = registeredCollectors_1.next()
      ) {
      ...
      try {
        if (
          registeredCollectors_1_1 &&
          !registeredCollectors_1_1.done &&
          (_a = registeredCollectors_1.return)
        )
  ...
  TemporalMetricProcessor.prototype._getMergedUnreportedAccumulations =
    function (collector) {
      var e_2, _a;
      ...
      try {
        for (
          var unreportedList_1 = __values(unreportedList),
            unreportedList_1_1 = unreportedList_1.next();
          !unreportedList_1_1.done;
          unreportedList_1_1 = unreportedList_1.next()
        ) {
   ...
   */
  TemporalMetricProcessor.calibrateStartTime = function (
    last,
    current,
    lastCollectionTime
  ) {
    ...
    try {
      for (
        var _b = __values(last.keys()), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        ...
        currentAccumulation === null || currentAccumulation === void 0
          ? void 0
