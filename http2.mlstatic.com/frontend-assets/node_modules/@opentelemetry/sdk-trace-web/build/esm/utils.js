...
export function getResource(
  ...
  var filteredResources = filterResourcesForSpan(
    spanUrl,
    startTimeHR,
    endTimeHR,
    resources,
  ...
  if (parsedSpanUrl.origin !== getOrigin() && sorted.length > 1) {
    ...
    var mainRequest = findMainRequest(
      sorted,
...
function findMainRequest(
  ...
  var minTime = hrTimeToNanoseconds(
  ...
  for (var i = 1; i < length; i++) {
    ...
    var resourceStartTime = hrTimeToNanoseconds(
      timeInputToHrTime(resource[PTN.FETCH_START])
    );
    var resourceEndTime = hrTimeToNanoseconds(
