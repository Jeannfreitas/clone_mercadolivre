var t,
  ...
  T = function (t) {
    "hidden" === document.visibilityState &&
      g > -1 &&
      ((g = "visibilitychange" === t.type ? t.timeStamp : 0), E());
  },
  y = function () {
...
q.push(
  ...
  function (t) {
    ...
    for (var r = V.length - 1; r >= 0; r--) {
      ...
      if (Math.abs(n - i.renderTime) <= 8) {
        ((e = i).startTime = Math.min(t.startTime, e.startTime)),
          (e.processingStart = Math.min(t.processingStart, e.processingStart)),
    ...
    e ||
      ...
      V.push(e)),
      (t.interactionId || "first-input" === t.entryType) && G.set(t, e),
      X();
  }
);
var Z,
      ...
      (e = e || {}),
        b(function () {
          ...
          if (o) {
            ...
            var c = v(function () {
              at[i.id] ||
                (a(o.takeRecords()), o.disconnect(), (at[i.id] = !0), n(!0));
            });
      ...
      "pointerdown" == t.type
        ? (function (t, e) {
            var n = function () {
              ...
              i = function () {
                removeEventListener("pointerup", n, dt),
                  removeEventListener("pointercancel", r, dt);
              };
            addEventListener("pointerup", n, dt),
              addEventListener("pointercancel", r, dt);
          })(e, t)
        : mt(e, t);
    }
  },
